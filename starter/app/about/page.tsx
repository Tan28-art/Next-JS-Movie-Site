  ...
  return (
    <div className="space-y-4 p-2 px-5 mx-auto">
      ...
      <div className = "lg:text-xl space-y-4">
          <p>
            Welcome to ViBe Finder, your go-to source for all things movies! Our goal
          ...
          <p>
            ViBe Finder was created by one person who wanted to share their passion
          ...
          <p>
            At ViBe Finder, we provide a growing database of movies across various
